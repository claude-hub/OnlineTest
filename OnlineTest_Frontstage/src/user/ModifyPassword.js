...
class ModifyPassword extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            userServices.changePassword({uId:this.props.uId,nPassword:values.new_password
            }).then(ret => {
                    ...
                    <AForm onSubmit={this.handleSubmit.bind(this)}>
                        <FormItem label="原密码" {...formItemLayout}>
                            {getFieldDecorator('password', {
                                ...
                                <Input placeholder="原始密码" type="password" maxLength="20"/>
                            )}
                        </FormItem>
...
ModifyPassword = AForm.create()(ModifyPassword);
