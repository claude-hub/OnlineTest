export default function (state, action) {
    state = state || JSON.parse(localStorage.getItem('online_test_user_session')) || {
        Authorization: null,
    ...
    switch (action.type) {
        case 'SESSION:UP':
            ...
            localStorage.setItem('online_test_user_session', JSON.stringify(new_state));
            return new_state;
        case 'TOKEN:SET':
        ...
        case 'USER:SET':
            ...
            return new_state;
        case 'SESSION:DOWN':
            localStorage.setItem('online_test_user_session', null);
